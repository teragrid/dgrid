...
func DefaultBaseConfig(name string) BaseConfig {
	return BaseConfig{
		...
		ProxyApp:          fmt.Sprintf("tcp://127.0.0.1:%d", 26658+portStep),
		Asura:             "socket",
...
func DefaultRPCConfig() *RPCConfig {
	return &RPCConfig{
		...
		ListenAddress:     fmt.Sprintf("tcp://127.0.0.1:%d", 26657+portStep),
		GRPCListenAddress: "",
		Unsafe:            false,
	}
}
...
func DefaultP2PConfig() *P2PConfig {
	return &P2PConfig{
		ListenAddress: fmt.Sprintf("tcp://127.0.0.1:%d", 26656+portStep),

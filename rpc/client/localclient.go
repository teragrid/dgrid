...
import (
	...
	tmpubsub "github.com/teragrid/dgrid/pkg/pubsub"
	tmquery "github.com/teragrid/dgrid/pkg/pubsub/query"
	nm "github.com/teragrid/dgrid/node"
	"github.com/teragrid/dgrid/rpc/core"
...
* Communication between an Asura app and Dgrid core when they
are compiled in process.

For real clients, you probably want to use client.HTTP.  For more
powerful control during testing, you probably want the "client/mock" package.

You can subscribe for any event published by Dgrid using Subscribe method.
Note delivery is best-effort. If you don't read events fast enough, Dgrid
...
func (c *Local) AsuraInfo() (*ctypes.ResultAsuraInfo, error) {
	return core.AsuraInfo(c.ctx)
}
...
func (c *Local) AsuraQueryWithOptions(path string, data cmn.HexBytes, opts AsuraQueryOptions) (*ctypes.ResultAsuraQuery, error) {
	return core.AsuraQuery(c.ctx, path, data, opts.Height, opts.Prove)
}

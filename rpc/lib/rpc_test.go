...
import (
	...
	client "github.com/teragrid/dgrid/rpc/lib/client"
	server "github.com/teragrid/dgrid/rpc/lib/server"
...
func setup() {
	logger := log.NewTGLoggerWithColorFn(log.NewSyncWriter(os.Stdout), colorFn)

...
import (
	...
	types "github.com/teragrid/dgrid/rpc/lib/types"
)
...
// To be properly decoded the arg must be a concrete type from teragrid (if its an interface).
...
// If some writes don't set it while others do, they may timeout incorrectly (https://github.com/teragrid/dgrid/issues/553)

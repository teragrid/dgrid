...
func TestProposalSignable(t *testing.T) {
	leagueID := "test_chain_id"
	signBytes := testProposal.SignBytes(leagueID)

	expected, err := cdc.MarshalBinaryLengthPrefixed(CanonicalizeProposal(leagueID, testProposal))

...
type EventBusSubscriber interface {
	Subscribe(ctx context.Context, subscriber string, query tpubsub.Query, outCapacity ...int) (Subscription, error)
	Unsubscribe(ctx context.Context, subscriber string, query tpubsub.Query) error
...
func NewEventBusWithBufferCapacity(cap int) *EventBus {
	...
	pubsub := tpubsub.NewServer(tpubsub.BufferCapacity(cap))
...
func (b *EventBus) Subscribe(ctx context.Context, subscriber string, query tpubsub.Query, outCapacity ...int) (Subscription, error) {
...
func (b *EventBus) SubscribeUnbuffered(ctx context.Context, subscriber string, query tpubsub.Query) (Subscription, error) {
	return b.pubsub.SubscribeUnbuffered(ctx, subscriber, query)
}

func (b *EventBus) Unsubscribe(ctx context.Context, subscriber string, query tpubsub.Query) error {
...
func (NopEventBus) Subscribe(ctx context.Context, subscriber string, query tpubsub.Query, out chan<- interface{}) error {
	return nil
}

func (NopEventBus) Unsubscribe(ctx context.Context, subscriber string, query tpubsub.Query) error {
	return nil
}

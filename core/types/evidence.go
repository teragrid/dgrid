...
type Evidence interface {
	...
	Verify(leagueID string, pubKey crypto.PubKey) error // verify the evidence
...
func RegisterEvidences(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&DuplicateVoteEvidence{}, "teragrid/DuplicateVoteEvidence", nil)
}

func RegisterMockEvidences(cdc *amino.Codec) {
	cdc.RegisterConcrete(MockGoodEvidence{}, "teragrid/MockGoodEvidence", nil)
	cdc.RegisterConcrete(MockRandomGoodEvidence{}, "teragrid/MockRandomGoodEvidence", nil)
	cdc.RegisterConcrete(MockBadEvidence{}, "teragrid/MockBadEvidence", nil)
}
...
func (dve *DuplicateVoteEvidence) Verify(leagueID string, pubKey crypto.PubKey) error {
	...
	if !pubKey.VerifyBytes(dve.VoteA.SignBytes(leagueID), dve.VoteA.Signature) {
		return fmt.Errorf("DuplicateVoteEvidence Error verifying VoteA: %v", ErrVoteInvalidSignature)
	}
	if !pubKey.VerifyBytes(dve.VoteB.SignBytes(leagueID), dve.VoteB.Signature) {
...
func (e MockGoodEvidence) Verify(leagueID string, pubKey crypto.PubKey) error { return nil }
...
func (e MockBadEvidence) Verify(leagueID string, pubKey crypto.PubKey) error {

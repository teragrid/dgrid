...
const (
	// MaxLeagueIDLen is a maximum length of the chain ID.
	MaxLeagueIDLen = 50
)
...
// docs/teragrid-core/using-teragrid.md
...
// GenesisDoc defines the initial conditions for a teragrid blockchain, in particular its validator set.
...
func (genDoc *GenesisDoc) ValidateAndComplete() error {
	...
	if len(genDoc.LeagueID) > MaxLeagueIDLen {
		return cmn.NewError("chain_id in genesis doc is too long (max: %d)", MaxLeagueIDLen)
	}

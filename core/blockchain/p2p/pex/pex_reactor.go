...
import (
	...
	"github.com/teragrid/dgrid/core/blockchain/p2p/conn"
)
...
func RegisterPexMessage(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&pexRequestMessage{}, "dgrid/core/blockchain/p2p/PexRequestMessage", nil)
	cdc.RegisterConcrete(&pexAddrsMessage{}, "dgrid/core/blockchain/p2p/PexAddrsMessage", nil)
}

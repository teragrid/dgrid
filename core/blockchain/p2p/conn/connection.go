...
import (
	...
	flow "github.com/teragrid/dgrid/pkg/flowrate"
	...
	for {
		...
		*/
		...
		case PacketPing:
			...
			// https://github.com/teragrid/dgrid/issues/1190
...
func RegisterPacket(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(PacketPing{}, "dgrid/core/blockchain/p2p/PacketPing", nil)
	cdc.RegisterConcrete(PacketPong{}, "dgrid/core/blockchain/p2p/PacketPong", nil)
	cdc.RegisterConcrete(PacketMsg{}, "dgrid/core/blockchain/p2p/PacketMsg", nil)
}

...
func (pc peerConn) ID() ID {
	return PubKeyToID(pc.conn.(*tconn.SecretConnection).RemotePubKey())
}
...
func (p *peer) Status() tconn.ConnectionStatus {
...
func createMConnection(
	...
	return tconn.NewMConnectionWithConfig(
		conn,
		chDescs,
		onReceive,
		onError,

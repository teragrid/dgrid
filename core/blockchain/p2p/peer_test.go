...
import (
	...
	"github.com/teragrid/dgrid/core/config"
	tconn "github.com/teragrid/dgrid/core/blockchain/p2p/conn"
)
...
func TestPeerBasic(t *testing.T) {
	...
	p, err := createOutboundPeerAndPerformHandshake(rp.Addr(), cfg, tconn.DefaultMConnConfig())
	require.Nil(err)
...
func TestPeerSend(t *testing.T) {
	...
	p, err := createOutboundPeerAndPerformHandshake(rp.Addr(), config, tconn.DefaultMConnConfig())
	require.Nil(err)
...
func createOutboundPeerAndPerformHandshake(
	...
	mConfig tconn.MConnConfig,
) (*peer, error) {
	chDescs := []*tconn.ChannelDescriptor{

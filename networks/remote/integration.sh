...
REPO=github.com/teragrid/dgrid
go get $REPO
cd $GOPATH/src/$REPO
...
cd $GOPATH/src/github.com/teragrid/dgrid/networks/remote/terraform
...
cd $GOPATH/src/github.com/teragrid/dgrid/networks/remote/ansible

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/teragrid/dgrid/build/teragrid -e CONFIGDIR=$GOPATH/src/github.com/teragrid/dgrid/docs/examples
...
old_ansible_file=$GOPATH/src/github.com/teragrid/dgrid/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
...
ExecStart=/usr/bin/teragrid node --proxy_app=kvstore --p2p.persistent_peers=$id0@$ip0:26656,$id1@$ip1:26656,$id2@$ip2:26656,$id3@$ip3:26656

...
var (
	...
	Version string = TeragridCoreVersion
)
...
const (
	// TeragridCoreVersion is the current version of Teragrid Core.
	// It's the Semantic Version of the software.
	// Must be a string because scripts like dist.sh read this file.
	// XXX: Don't change the name of this variable or you will break
	// automation :)
	TeragridCoreVersion = "0.31.5"

	// AsuraVersion is the semantic version of the Asura library
	AsuraVersion = "0.16.0"
)
...
// eg. for compatibility with Asura types.

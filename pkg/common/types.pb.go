...
func init() { proto.RegisterFile("pkg/common/types.proto", fileDescriptor_types_a863d437ea36eb85) }
func init() {
	golang_proto.RegisterFile("pkg/common/types.proto", fileDescriptor_types_a863d437ea36eb85)
}

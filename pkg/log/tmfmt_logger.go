...
// Dgrid custom format. Note complex types (structs, maps, slices)
// formatted as "%+v".
//
...
func (l tmfmtLogger) Log(keyvals ...interface{}) error {
	...
	// Form a custom Dgrid line
	//
	// Example:
	//     D[2016-05-02|11:06:44.322]   Stopping AddressBook (ignoring: already stopped)
	//
	// Description:

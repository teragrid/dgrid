...
# events
`import "github.com/tgrid/tgrid/pkg/events"`
...
[event_cache.go](/src/github.com/tgrid/tgrid/pkg/events/event_cache.go) [events.go](/src/github.com/tgrid/tgrid/pkg/events/events.go) 
...
```
Generic event data can be typed and registered with tgrid/go-amino

...
import (
	...
	"github.com/teragrid/dgrid/asura/example/code"
	...
	servertest "github.com/teragrid/dgrid/asura/tests/server"
	"github.com/teragrid/dgrid/asura/types"
	"github.com/teragrid/dgrid/asura/version"
...
var RootCmd = &cobra.Command{
	Use:   "asura",
	Short: "the Asura CLI tool wraps an Asura client",
	Long:  "the Asura CLI tool wraps an Asura client and is used for testing Asura servers",
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if logger == nil {
			...
			logger = log.NewFilter(log.NewTGLogger(log.NewSyncWriter(os.Stdout)), allowLevel)
		}
		if client == nil {
			var err error
			client, err = asura.NewClient(flagAddress, flagAbci, false)
			if err != nil {
				return err
			}
...
func addGlobalFlags() {
	...
	RootCmd.PersistentFlags().StringVarP(&flagAbci, "asura", "", "socket", "either socket or grpc")
...
var batchCmd = &cobra.Command{
	Use:   "batch",
	Short: "run a batch of asura commands against an application",
	Long: `run a batch of asura commands against an application

This command is run by piping in a file containing a series of commands
you'd like to run:

    asura batch < example.file
...
var consoleCmd = &cobra.Command{
	Use:   "console",
	Short: "start an interactive Asura console for multiple commands",
	Long: `start an interactive Asura console for multiple commands
...
var versionCmd = &cobra.Command{
	Use:   "version",
	Short: "print Asura console version",
	Long:  "print Asura console version",
	Args:  cobra.ExactArgs(0),
	RunE: func(cmd *cobra.Command, args []string) error {
...
var counterCmd = &cobra.Command{
	Use:   "counter",
	Short: "Asura demo example",
	Long:  "Asura demo example",
	Args:  cobra.ExactArgs(0),
	RunE: func(cmd *cobra.Command, args []string) error {
...
func muxOnCommands(cmd *cobra.Command, pArgs []string) error {
	if len(pArgs) < 2 {
		return errors.New("expecting persistent args of the form: asura [command] <...>")
	}

...
The app has no replay protection (other than what the storage provides).
...
1) persistence of state across app restarts (using Dgrid's Asura-Handshake mechanism)
